...
function getKurentoClient(callback) {
    if (kurentoClient !== null) {
        console.log('Kurento Client is null');
        return callback(null, kurentoClient);
    }

    console.log('Calling Kurento Client');
...
function startPresenter(sessionId, ws, sdpOffer, callback) {
  ...
  console.log('Getting Kurento client');
	...
	getKurentoClient((error, kurentoClient) => {
		if (error) {
      console.log('Error getting Kurento client', error);
			stop(sessionId);
			return callback(error);
		}
    ...
    console.log('Getting Kurento client callback');

		kurentoClient.create('MediaPipeline', function(error, pipeline) {
			if (error) {
        console.log('Get pipeline error', error);
				stop(sessionId);
				return callback(error);
			}
      ...
      console.log('Got Kurento pipeline', pipeline);
...
function startViewer(sessionId, ws, sdpOffer, callback) {
  ...
  console.log('==== Has presenter', presenter);
